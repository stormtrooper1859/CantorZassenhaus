...
int main9() {
    auto p = Polynomial("3x^5+1x^4+2x^3+4x^2+2x^1+2x^0");
...
int main10() {
    ...
    Polynomial p2 = Polynomial("2x^3+1x^1+1x^0");
...
int main15() {
    Polynomial p1 = Polynomial("1x^1");
    Polynomial p2 = Polynomial("1x^5+1x^4+1x^3+2x^1+2x^0");
...
int main16() {
    Polynomial p1 = Polynomial("1x^5+1x^4+1x^3+2x^1+2x^0");
    Polynomial h1 = Polynomial("1x^1");
...
int main17() {
    Polynomial p1 = Polynomial("1x^5+1x^4+1x^3+2x^1+2x^0");
    Polynomial p2 = Polynomial("1x^2+2x^1");
    auto r = gcd(p2, p1, 3);
    cout << r << "\n";
...
int main19() {
    Polynomial p1 = Polynomial("1x^4+1x^3+1x^1+2x^0");
...
// moved!
int main27() {
    // Polynomial p1 = Polynomial("1x^18+1x^17+1x^13+1x^12+1x^9+1x^7+1x^6+1x^5+1x^4+1x^3+1x^2+1x^1+1x^0");
    Polynomial p1 = Polynomial("1x^63+1x^0");
...
int main32() {
    ...
    Polynomial p1 = Polynomial("1x^312+1x^217+1x^46+1x^0");
