...
TEST(Polynomial, to_string) {
    Polynomial p1 = Polynomial("2x^5+3x^4+1x^2+2x^0");
...
TEST(Polynomial, div2) {
    Polynomial p1 = Polynomial("1x^5+1x^3+2x^0");
    Polynomial p2 = Polynomial("1x^1+1x^0");
...
TEST(Polynomial, add2) {
    Polynomial p1 = Polynomial("1x^3+4x^2+6x^1+3x^0");
    Polynomial p2 = Polynomial("6x^3+3x^2+2x^1+1x^0");
...
TEST(Polynomial, sub1) {
    Polynomial p1 = Polynomial("1x^3+4x^2+6x^1+3x^0");
    Polynomial p2 = Polynomial("1x^3+4x^2+2x^1+1x^0");
...
TEST(Polynomial, mul1) {
    Polynomial p1 = Polynomial("2x^3+1x^2+3x^1+1x^0");
    Polynomial p2 = Polynomial("4x^2+1x^1+2x^0");
...
TEST(Polynomial, mul2) {
    Polynomial p1 = Polynomial("2x^57+1x^48+3x^1+4x^0");
    Polynomial p2 = Polynomial("4x^2+1x^1+2x^0");
